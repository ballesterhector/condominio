				...
				<div class="saludo">
					...
					<div class="buscar">
						...
						<label for="" style="margin-left:10px">Periodo
							<input type="text" class="form-control" style="text-align:center;width:45%" name="peribusca" id="peribusca" autocomplete="off" pattern="(0[1-9]|1[012])[/](\d{4})" placeholder="MM/AAAA" aria-hidden="true" data-toggle="tooltip" data-placement="top" title='Formato MM/AAAA' >
						</label>
					</div>
					<div class="subsaludo">
										...
										foreach ($data as $filas) { ?>
											<tr>
												...
												<td class="" align="center">
														<a href='javascript: onclick(facturacionFactura(<?php echo $filas['numrecibo'] ?>))' class='fas fa-print fa-lg' aria-hidden="true" data-toggle="tooltip" data-placement="top" title='Recibo de pago'></a>
												</td>
											</tr>
									<?php } ?>
								<?php } ?>
									...
									<section class="modalempleados">
										<article class="">
											<div class="ladoA">
												...
												<label for="" style="margin-left:10px">Periodo
													<input type="text" class="form-control" style="text-align:center;width:55%" name="perio" id="perio" autocomplete="off" pattern="(0[1-9]|1[012])[/](\d{4})" placeholder="MM/AAAA" aria-hidden="true" data-toggle="tooltip" data-placement="top" title='Formato MM/AAAA' >
												</label>
											</div>
										</article>
									</section>
