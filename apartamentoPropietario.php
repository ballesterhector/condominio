...
?>
    <div class="titulo">
        ...
        <div class="columna2">
            <a href="#" onclick="window.open('http:aplicaciones/ayudas/apartamentos.pdf')" /><span class="icon-local_library" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="Manual"></span></a>
        </div>
        <div class="columna3">
            <a href="apartamentos.php"><span class="icon-reply1" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="Devolverse"></span></a>
        </div>
    </div>
	...
	<script src="jsBody/apartamento.js"></script>
    </div>
</body>
</html>