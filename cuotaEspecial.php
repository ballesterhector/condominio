    ...
    $obj= new conectarDB();
		$data= $obj->subconsulta("SELECT   ultimoCuotaEspecial() AS ultimoCE");
	       foreach ($data as $filas) { 
             $ultcorrelativo= $filas['ultimoCE'];
           } 

    $obj= new conectarDB();
		$data= $obj->subconsulta("SELECT   ultimoCuotaEspecial2() AS ultimoCE");
	       foreach ($data as $filas) { 
...
<html lang="es">
	...
	<body>
		<div class="contenedor">
			<header>
				...
				<div class="saludo">
					<div>
						<h3 class="titulos" id="respuesta">Data cuota especial</h3>
					</div>
					<div class="buscar">
						<label for="">
				...
				<article class="contenedor2">
					<div class="CE1">
						...
						<form id="formulario" class="form-horizontal" onsubmit="return agregarRegistro();">
								...
								<label for="" style="">
									<select class="form-control" title="" style="width:250px" name="edif" id="edif" onchange="producto()"></select>
								</label>
					...
					<div class="CE2">
						<table class="table table-condensed table-bordered table-responsive display compact" id="dataTables">
							...
							<tbody style="font-size:10px">
								<?php
									$obj= new conectarDB();
									$data= $obj->subconsulta("CALL gastosCEPeriodosSelect()");
									...
									if ($dat=='null') {
										...
										foreach ($data as $filas) { ?>
											<tr>
												...
												<td class="text-center"><?php echo date("d-m-Y",strtotime($filas['fechainicioPer'])) ?></td>
												<td class="text-center"><?php echo $filas['cuotasPer'] ?></td>
												<td class="dt-right"><?php echo number_format($filas['montoPer'],2) ?></td>
												<td class="text-center"><?php echo $filas['correlativo'] ?></td>
	...
	<div>
		...
		<script src="../aplicacionesCondominio/js/cuotaespecial.js"></script>
	</div>
	</body>
</html>